...
const tests = [
  // ...existing tests
  {
    name: "Count keys in object with varying size",
    cases: [
      {
        name: "Small object",
        setup: `const obj = {}; for (let i = 0; i < 10; i++) { obj[i] = i; }`,
        body: `countKeysInObject(obj)`
      },
      {
        name: "Medium object",
        setup: `const obj = {}; for (let i = 0; i < 100; i++) { obj[i] = i; }`,
        body: `countKeysInObject(obj)`
      },
      {
        name: "Large object",
        setup: `const obj = {}; for (let i = 0; i < 1000; i++) { obj[i] = i; }`,
        body: `countKeysInObject(obj)`
      }
    ]
  }
